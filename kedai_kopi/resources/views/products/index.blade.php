...
@section('content')
    <div class="min-h-screen bg-[#F8F3EA]">
        ...
        <section class="relative min-h-screen flex items-center overflow-hidden">
            ...
            <div class="absolute inset-0 bg-linear-to-r from-black via-black/40 to-transparent">
            </div>
            ...
            <div class="relative z-10 max-w-7xl mx-auto px-8 w-full">
                ...
                <h1 class="mt-8 text-7xl font-black text-white max-w-4xl leading-tight">
                ...
                <p class="mt-6 text-xl text-stone-300 max-w-2xl leading-relaxed">
            ...
            <div class="max-w-7xl mx-auto px-8">
                ...
                <div
                    ...
                    <div class="flex flex-col lg:flex-row gap-4">
                        ...
                        <select class="px-6 py-4 rounded-2xl border border-stone-200">
        ...
        <section class="pb-24">
            ...
            <div class="max-w-7xl mx-auto px-8">
                ...
                <div class="text-center mb-20">
                    ...
                    <span class="inline-flex items-center gap-3 px-6 py-3 rounded-full bg-white shadow-lg">
                    ...
                    <h2 class="text-6xl font-black text-[#2B2118] mt-8">

                        Semua Produk KOPIN

                    </h2>

                    <p class="text-xl text-stone-500 mt-5 max-w-2xl mx-auto">
                    ...
                    @foreach ($products as $index => $product)
                        ...
                        <div data-aos="zoom-in"
                            ...
                            <div class="absolute top-6 left-6 right-6 flex justify-between z-20">
                                ...
                                <span class="px-4 py-2 rounded-full bg-[#8B5E3C] text-white text-sm font-semibold">
                            ...
                            <div class="absolute bottom-0 left-0 right-0 p-8 text-white z-20">
                                ...
                                <p class="mt-4 text-stone-200 line-clamp-2 text-lg">
                                ...
                                <div class="flex flex-wrap gap-2 mt-6">
                                    ...
                                    @foreach ($variants as $variant)
                                        <span class="px-4 py-2 rounded-full bg-white/10 backdrop-blur-md text-sm">
