...
@section('content')
    ...
    <!-- HERO REPORT -->
    <div class="relative overflow-hidden bg-linear-to-r from-[#6F4E37] to-[#A67B5B] rounded-[36px] text-white p-10 mb-8 shadow-2xl">
    ...
    <div class="bg-white rounded-[30px] shadow-xl p-8 mb-8 border border-[#EFE3D5]">
        ...
        <div class="bg-linear-to-br from-[#FCFAF8] to-[#F7F1EA] rounded-3xl p-6 border border-[#EFE3D5]">
            <div class="h-96">
                ...
                @foreach ($topMenu as $item)
                    <div>
                        ...
                        <div class="w-full bg-stone-200 rounded-full h-4">
                            <div class="bg-[#6F4E37] h-4 rounded-full" style="width: {{ $item->percentage }}%"></div>
                        </div>
                    </div>
                @endforeach
            </div>
