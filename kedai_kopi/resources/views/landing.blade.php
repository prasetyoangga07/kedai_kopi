...
<!-- HERO -->
<section class="relative min-h-screen overflow-hidden flex items-center pt-24">

    <!-- BACKGROUND -->

    <div class="absolute inset-0">

        <img src="https://images.unsplash.com/photo-1509042239860-f550ce710b93?auto=format&fit=crop&w=2000&q=80"
    ...
    <div class="relative z-10 max-w-7xl mx-auto px-8 w-full" id="home">
        <div class="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <!-- LEFT -->
            <div>
                <div class="inline-flex items-center gap-3 px-5 py-3 rounded-full bg-white/10 backdrop-blur-xl border border-white/20 text-white">
                ...
                <h1 class="mt-8 text-6xl lg:text-8xl font-black leading-none text-white">
                    Ngopi
                    Lebih
                    Pintar
                </h1>

                <p class="mt-8 text-xl text-stone-200 max-w-2xl leading-relaxed">
...
<!-- PRODUK  -->
<section id="produk" class="relative py-1 overflow-hidden"> 
    <!-- ===================================== -->
    ...
    <section id="produk" class="py-10 bg-[#F8F3EA]">
        ...
        <div class="max-w-7xl mx-auto px-8">
            ...
            <div class="text-center mb-20" data-aos="fade-up">
                ...
                <span class="inline-flex items-center gap-2 px-5 py-3 rounded-full bg-white shadow-lg">
                ...
                <h2 class="text-6xl font-black mt-8 text-[#2B2118]">
    
                    Produk Favorit Pelanggan
    
                </h2>
    
                <p class="mt-5 text-xl text-stone-500">
        ...
        text-white text-xs font-bold shadow-lg">
                                    ...
                                    <x-heroicon-s-fire class="w-4 h-4 inline-block mr-1" />
                            ...
                            <img src="https://images.unsplash.com/photo-1495474472287-4d71bcdd2085?auto=format&fit=crop&w=1200&q=80"
                                class="h-105 w-full object-cover group-hover:scale-110 transition duration-700">
    
                            <div class="absolute inset-0 bg-linear-to-t from-black via-black/10 to-transparent">
                            </div>
    
                            <div class="absolute bottom-0 left-0 p-8 text-white">
    
                                <span class="px-4 py-2 rounded-full bg-[#8B5E3C] text-sm">
    ...
    <section id="outlet" class="relative py-32 overflow-hidden">
        ...
        <div class="absolute inset-0">
            ...
            <div class="absolute inset-0 bg-[#1A120B]/85">
            </div>
        ...
        <div class="relative z-10 max-w-7xl mx-auto px-8">
            ...
            <div class="text-center mb-20" data-aos="fade-up">
                ...
                <h2 class="text-6xl font-black text-white mt-8">
            ...
            <div class="grid lg:grid-cols-3 gap-8">
                ...
                <div data-aos="fade-up"
                    ...
                    <img src="https://images.unsplash.com/photo-1554118811-1e0d58224f24?auto=format&fit=crop&w=1200&q=80"
                ...
                <div data-aos="fade-up" data-aos-delay="300"
                    ...
                    <img src="https://images.unsplash.com/photo-1445116572660-236099ec97a0?auto=format&fit=crop&w=1200&q=80"
                        class="h-72 w-full object-cover group-hover:scale-110 transition duration-700">
    ...
    <section id="benefit" class="py-32 bg-[#120C07]">
        ...
        <div class="max-w-7xl mx-auto px-8">
            ...
            <div class="text-center mb-24" data-aos="fade-up">
                ...
                <p class="mt-6 text-xl text-stone-400">
            ...
            <div class="grid lg:grid-cols-3 gap-10">
                ...
                <div data-aos="fade-up"
                    ...
                    <div class="w-20 h-20 rounded-3xl bg-[#8B5E3C] flex items-center justify-center">
    
                        <x-heroicon-o-gift class="w-10 h-10 text-white" />
    
                    </div>
    
                    <h3 class="text-3xl font-bold text-white mt-8">
    
                        Promo Eksklusif
    
                    </h3>
    
                    <p class="text-stone-400 mt-5 leading-relaxed">
    ...
    <section class="relative overflow-hidden py-32 bg-[#2B2118]">
    
    
        <div class="absolute inset-0">
    
            <img src="https://images.unsplash.com/photo-1495474472287-4d71bcdd2085?auto=format&fit=crop&w=2000&q=80"
                class="w-full h-full object-cover">
    
            <div class="absolute inset-0 bg-[#2B2118]/85">
            </div>
        ...
        <div class="relative z-10 max-w-5xl mx-auto px-8 text-center">
            ...
            <div data-aos="zoom-in">
                ...
                <h2 class="text-6xl font-black text-white mt-8 leading-tight">
                ...
                <p class="text-xl text-stone-300 mt-8">
    ...
    <section class="py-32 bg-[#F8F3EA]">
        ...
        <div class="max-w-7xl mx-auto px-8">
            ...
            <div class="grid lg:grid-cols-3 gap-8">
                ...
                <div data-aos="fade-up" class="bg-white rounded-[40px] p-10 shadow-xl">
                ...
                <div data-aos="fade-up" data-aos-delay="150" class="bg-white rounded-[40px] p-10 shadow-xl">
                ...
                <div data-aos="fade-up" data-aos-delay="300" class="bg-white rounded-[40px] p-10 shadow-xl">
    ...
    <footer class="bg-[#120C07] text-white">
        ...
        <div class="max-w-7xl mx-auto px-8 py-24">
            ...
            <div class="grid lg:grid-cols-4 gap-16">
                ...
                <div>
                    ...
                    <p class="text-stone-400 mt-6 leading-relaxed">
            ...
            <div class="border-t border-white/10 mt-16 pt-8 text-center text-stone-500">
