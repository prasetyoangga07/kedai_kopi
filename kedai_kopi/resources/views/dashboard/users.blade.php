    ...
    <div x-data='usersJs({
        ...
        <div class="bg-white border border-[#E8D8C4] rounded-[28px] p-4 shadow-lg mb-8">
            <div class="flex items-center gap-4">
                <div class=" flex items-center flex-1 h-12 px-4 bg-[#FAF9F6] border border-[#E8D8C4] rounded-2xl">

                    <x-heroicon-o-magnifying-glass class="h-5 w-5"/>

                    <input type="text" x-model="search" placeholder="Cari campaign..."
                        class=" flex-1 ml-3 bg-transparent border-0 outline-none focus:ring-0">
                ...
                <div class="flex items-center bg-[#F5F6F8] p-1.5 rounded-2xl shadow-inner gap-1">
                    ...
                    <button @click="applyFilter('staff')"
                        :class="statusFilter == 'staff' ?
                    ...
                    <button @click="applyFilter('customer')"
                        :class="statusFilter == 'customer' ?
            ...
            <form @submit.prevent="submit()">
                <div class="p-6 space-y-4">
                    ...
                    <div class="grid grid-cols-2 gap-3">
                        <div>
                            <label class="text-xs uppercase tracking-wide text-stone-600 font-semibold block mb-1">Nama
                                Lengkap</label>
                        ...
                        <div>
                            <label
                                class="text-xs uppercase tracking-wide text-stone-600 font-semibold block mb-1">Email</label>
                    ...
                    <div class="grid grid-cols-2 gap-3">
                        <div>
                            <label class="text-xs uppercase tracking-wide text-stone-600 font-semibold block mb-1">Role
                                Jabatan</label>
        ...
        <div @click.away="showDelete=false"
            ...
            <div class="p-8 text-center">
                ...
                <p class="text-stone-500 mt-4 leading-relaxed">
                    Akun ini akan dihapus secara permanen dari sistem CRM. Staf yang bersangkutan tidak akan bisa login
                    kembali.
                </p>
            </div>
