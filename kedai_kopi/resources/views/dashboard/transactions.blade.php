    ...
    <div class="bg-white border border-[#E8D8C4] rounded-[28px] p-4 shadow-lg">
        ...
        <div class="flex flex-wrap gap-3">
            ...
            <a href="{{ route('transactions.index') }}"
                class="inline-flex items-center justify-center min-w-[110px] px-5 py-3 rounded-2xl font-semibold transition-all duration-200
                ...
                <tbody>
                    ...
                    <tr class="border-t border-[#EFE3D5] hover:bg-[#FCF8F3]">
                        ...
                        <td class="px-6 py-4">
                            ...
                            <span class="px-3 py-1 rounded-full bg-yellow-100 text-yellow-700 font-bold text-sm">
                                PENDING
                            </span>
                        ...
                        <td class="px-6 py-4 text-center">
                            ...
                            <form
                                id="approveForm{{ $transaction->id }}"
                                action="{{ route('transactions.approve', $transaction->id) }}"
                                method="POST">
                                ...
                                <button
                                    type="button"
                                    onclick="confirmApprove({{ $transaction->id }})"
